...
- [1. Sensitive Data Exposure](#sensitive-data-exposure)
  - [1.1 Accessing Sensitive Documents](#accessing-sensitive-documents)
- [2. Broken Access Control](#broken-access-control)
  - [2.1 Pulling User-Data as a Low-Privilege User](#pulling-user-data-as-a-low-privilege-user)
- [3. Injection](#injection)
  - [3.1 Login Admin](#login-admin)
  - [3.2 Database Schema & User Credentials](#database-schema-&-user-credentials)
